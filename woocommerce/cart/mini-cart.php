...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button"><?php _e( 'View Cart', 'understrap' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button"><?php _e( 'Checkout', 'understrap' ); ?></a>
	</p>
